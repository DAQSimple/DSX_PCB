...
* [AutoDesk Eagle](https://www.autodesk.ca/en/products/eagle/free-download)
* [AutoDesk Fusion 360](https://www.autodesk.ca/en/products/fusion-360/free-trial)

### Installation

1. Clone the repo
   ```sh
   git clone https://github.com/DAQSimple/DSX_PCB
   ```
